...
import { LIGHT_GRAY, PRIMARY } from '../../constants/websiteColors';
...
const Spinner = styled.div`
  ...
  border-top: 4px solid ${LIGHT_GRAY};
  border-right: 4px solid ${LIGHT_GRAY};
  border-bottom: 4px solid ${LIGHT_GRAY};
